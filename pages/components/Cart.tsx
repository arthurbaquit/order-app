...
export const Cart = ({onClickHandler}: { onClickHandler: () => void }) => {
    ...
    useEffect(
        () => {
            ...
            setTotalAmount(+totalAmountAux.reduce((previous, currenty) => currenty + previous, 0).toFixed(2))
        }, [cart.cartItems]
    )
    ...
    return (
        <Modal onClickHandler={onClickHandler}>
            ...
            <div className={styles.actions}>
                <button className={styles['button-alt']} onClick={onClickHandler}>Close</button>
